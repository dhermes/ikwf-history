...
def extract_bracket(weight, divison):
    ...
    matches = [
        ...
        },
        {
            ...
            "winner": ("consolation_round3_01", "bottom_competitor"),
        },
        {
            "match": "consolation_round2_03",
            ...
            "winner": ("consolation_round3_02", "top_competitor"),
        },
        {
            "match": "consolation_round2_04",
            "top_competitor": parse_competitor(consolation_lines[13][26:52]),
            "bottom_competitor": None,
            "result": "Bye",
            "bout_number": None,
        },
        {
            "match": "consolation_round2_05",
        ...
        },
        {
            ...
            "winner": ("consolation_round3_03", "bottom_competitor"),
        },
        {
            "match": "consolation_round2_07",
            ...
            "winner": ("consolation_round3_04", "top_competitor"),
        },
        {
            "match": "consolation_round2_08",
            "top_competitor": parse_competitor(consolation_lines[27][26:52]),
            "bottom_competitor": None,
            "result": "Bye",
            "bout_number": None,
        },
...
def main():
    ...
    for weight in novice_weights:
        matches = extract_bracket(weight, "novice")
        parsed.append(
            {
                "division": "novice",
                "weight": weight,
    ...
    for weight in senior_weights:
        matches = extract_bracket(weight, "senior")
        parsed.append(
            {
                "division": "novice",
                "weight": weight,
