...
_NAME_EXCEPTIONS: dict[tuple[str, str], bracket_utils.Competitor] = {
    ...
    ("Gage La Dere", "Lincoln-Way WC"): bracket_utils.Competitor(
        first_name="Gage", last_name="La Dere", suffix=None, team="Lincoln-Way WC"
    ),
    ("Hiran Lopez Marquez", "Tomcat WC"): bracket_utils.Competitor(
        first_name="Hiran", last_name="Lopez Marquez", suffix=None, team="Tomcat WC"
    ),
    ...
    ("Lee Jr Smith", "Dakota WC"): bracket_utils.Competitor(
        first_name="Lee", last_name="Smith", suffix="Jr", team="Dakota WC"
    ),
