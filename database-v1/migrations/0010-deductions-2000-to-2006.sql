...
VALUES
  (1,  32, 171,   'HRD', 'HINSDALE RED DEVILS',        '', 1), -- 2001
  ...
  (8,  33, 206,   'KNI', 'KNIGHTS WRESTLING',          '', 1), -- 2002
  (9,  33, 10171, 'LAO', 'LAN-OAK P.D. LITTLE REBELS', '', 1), -- 2002
  ...
  (16, 34, 134,   'FOX', 'FOX VALLEY WC',              '', 1), -- 2003
  (17, 34, 10061, 'LIM', 'LIMESTONE YOUTH WC',         '', 1), -- 2003
  (18, 34, 354,   'RIV', 'RIVERBEND WC',               '', 1), -- 2003
  (19, 34, 361,   'ROK', 'ROCK ISLAND WC',             '', 1), -- 2003
  ...
  (26, 35, 10042, 'HER', 'HERRIN WC',                  '', 1), -- 2004
  (27, 35, 172,   'HOF', 'HOFFMAN ESTATES WC',         '', 1), -- 2004
  (28, 35, 206,   'KNI', 'KNIGHTS WRESTLING',          '', 1), -- 2004
  (29, 35, 248,   'MAR', 'MARENGO WC',                 '', 1), -- 2004
  (30, 35, 248,   'MAR', 'MARENGO WC',                 '', 1), -- 2004
  (31, 35, 263,   'MID', 'MIDWEST CENTRAL YOUTH',      '', 1), -- 2004
  (32, 35, 271,   'MLM', 'MORTON LITTLE MUSTANGS',     '', 1), -- 2004
  (33, 35, 271,   'MLM', 'MORTON LITTLE MUSTANGS',     '', 1), -- 2004
  (34, 35, 272,   'MRT', 'MORTON YOUTH WRESTLING',     '', 1), -- 2004
  (35, 35, 295,   'NOT', 'NOTRE DAME WRESTLING',       '', 1), -- 2004
  (36, 35, 326,   'PLA', 'PLAINFIELD WC',              '', 1), -- 2004
  (37, 35, 236,   '',    'RAMS WC',                    '', 1), -- 2004; no athletes?
  (38, 35, 349,   'RIC', 'RICH RATTLERS WC',           '', 1), -- 2004
  (39, 35, 349,   'RIC', 'RICH RATTLERS WC',           '', 1), -- 2004
  (40, 35, 397,   'SPR', 'SPRINGFIELD CAPITALS',       '', 1), -- 2004
  (41, 35, 10096, 'SCE', 'ST. CHARLES EAST WC',        '', 1), -- 2004
  (42, 35, 10096, 'SCE', 'ST. CHARLES EAST WC',        '', 1), -- 2004
