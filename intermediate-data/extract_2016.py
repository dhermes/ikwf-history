...
_NAME_FIXES: dict[str, str] = {
    ...
    "Tuvshinjar Zuunbayan": "Tuvshinjargal Zuunbayan",
}
_NAME_EXCEPTIONS: dict[tuple[str, str], bracket_utils.Competitor] = {
    ...
    ("Noah Manuel Tapia", "Young Guns Wrestling"): bracket_utils.Competitor(
        full_name="",
        first_name="Noah Manuel",
        last_name="Tapia",
        team_full="Young Guns Wrestling",
        team_acronym=None,  # TODO
    ),
}
...
def main():
    root = HERE.parent / "raw-data" / "2016"
    ...
    with open(HERE / "extracted.2016.json", "w") as file_obj:
