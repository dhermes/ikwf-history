...
_SENIOR_PLACERS: dict[int, list[bracket_utils.Placer]] = {
    60: [
        ...
        bracket_utils.Placer(name="Joey Sukley", team="Indian Trail Wildcats"),
    ...
    77: [
        ...
        bracket_utils.Placer(name="Ben King", team="Lions WC (LaGrange)"),
    ...
    87: [
        bracket_utils.Placer(name="Michael French", team="Mattoon WC"),
    ...
    112: [
        ...
        bracket_utils.Placer(name="Robert Ott", team="Indian Prairie Trailblazers"),
    ...
    135: [
        ...
        bracket_utils.Placer(name="Kasey Alexander", team="Mattoon WC"),
    ...
    144: [
        ...
        bracket_utils.Placer(name="Chris Klaska", team="Decatur WC"),
    ...
    173: [
        ...
        bracket_utils.Placer(name="Albert Mendoza", team="Dolton Park Falcons"),
        bracket_utils.Placer(name="Matt Feltz", team="Harlem School District"),
    ],
    185: [
        ...
        bracket_utils.Placer(name="Mike Scaggs", team="Knights WC"),
    ],
    275: [
        ...
        bracket_utils.Placer(name="John Carlson", team="Harlem School District"),
...
_SENIOR_TEAM_SCORES: dict[str, float] = {
    ...
    "Arlington Cardinals": 102.0,
    "Bismarck Henning": 85.0,
