...
_NOVICE_TEAM_SCORES: dict[str, float] = {
    "FOX VALLEY WC": 179.0,
    "HARVEY PARK DIST TWISTERS": 127.0,
    ...
    "ROXANA KIDS WRESTLING CLUB": 61.5,
    ...
    "PANTHER CUB WRESTLING CLUB": 0.0,
...
_SENIOR_TEAM_SCORES: dict[str, float] = {
    ...
    "PANTHER WC": 77.5,
    "HARVEY PARK DIST TWISTERS": 76.0,
    ...
    "RICHMOND WRESTLING CLUB": 32.0,
    "MATTOON YOUTH WC": 31.5,
    "PANTHER CUB WRESTLING CLUB": 31.0,
    ...
    "ROCK ISLAND WC": 4.0,
    "SPRINGFIELD CAPITALS": 4.0,
    "WOLFPAK WC": 4.0,
    "YORKVILLE WRESTLING CLUB": 4.0,
    ...
    "BISMARCK HENNING WRESTLING CLUB": 0.0,
    "BLACK KATS WC": 0.0,
    ...
    "ROCK RIDGE WC": 0.0,
    "ROMEOVILLE WC": 0.0,
    "ROXANA KIDS WRESTLING CLUB": 0.0,
    "SAUKEE YOUTH WC": 0.0,
    "SAVANNA REDHAWKS": 0.0,
    "SENECA IRISH CADETS": 0.0,
    "SHAMROCK WC": 0.0,
