...
_NAME_EXCEPTIONS: dict[tuple[str, str], bracket_utils.Competitor] = {
    ...
    (
        ...
        last_name="Hilliard",
        team_full="Proviso Township Gladiators WC",
    ),
    ...
    ("Paxton De La Vega", "Tinley Park Bulldogs WC"): bracket_utils.Competitor(
        ...
        team_full="Tinley Park Bulldogs WC",
    ),
