...
_NAME_EXCEPTIONS: dict[tuple[str, str], bracket_utils.Competitor] = {
    ...
    ("Brent Hills Ii", "Champions WC"): bracket_utils.Competitor(
        first_name="Brent", last_name="Hills", suffix="II", team="Champions WC"
    ),
    ...
    ("Elina Del Rio", "Caravan Kids WC"): bracket_utils.Competitor(
        first_name="Elina", last_name="Del Rio", suffix=None, team="Caravan Kids WC"
    ),
    ...
    ("Trinity Grace Larsen", "Fox Lake WC"): bracket_utils.Competitor(
        first_name="Trinity Grace", last_name="Larsen", suffix=None, team="Fox Lake WC"
    ),
}
