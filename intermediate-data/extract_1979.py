...
_SENIOR_COMPETITORS: dict[int, list[str | None]] = {
    ...
    70: [
        ...
        "Craig Sterr :: Hufford",
        "Kevin Powers :: Franklin Park Raiders",
    ...
    80: [
        ...
        "Peter Tarzygnat :: Franklin Park Raiders",
    ...
    95: [
        ...
        None,
        "Scott Fitzgibbons :: Franklin Park Raiders",
    ...
    155: [
        ...
        None,
        "Dave Vohaska :: Franklin Park Raiders :: 1",
    ...
    170: [
        ...
        "Mark Antonietti :: Calumet Park District",
        None,
...
_NAME_EXCEPTIONS: dict[tuple[str, str], bracket_utils.Competitor] = {
    ...
    ("Pierre", "Wheaton Park District"): bracket_utils.Competitor(
        full_name="Pierre",
        first_name="",
        last_name="Pierre",
        team_full="Wheaton Park District",
    ),
