...
_TEAM_ID_MAP = {  # NOTE: This is 2020-specific
    "AJ Jr. Wildcats": 40000,
    "Addison Street WC": 40001,
    "Alton Little Redbirds WC": 40002,
    "Arlington Cardinals WC": 40003,
...
def main():
    ...
    # start_id = 11228
    # current_id = start_id
    # for division in ("novice", "senior"):
    #     team_scores = extracted.team_scores[division]
    #     division_str = bracket_utils.sql_nullable_str(division)
    #     for team_score in team_scores:
    #         team_name = team_score.team
    #         team_id = _TEAM_ID_MAP[team_name]
    #         team_name_str = bracket_utils.sql_nullable_str(team_name)
    #         print(
    #             f"  ({current_id}, {TOURNAMENT_ID}, {division_str}, {team_id}, "
    #             f"'', {team_name_str}, {team_score.score}),"
    #         )
    #
    #         # Next iteration
    #         current_id += 1
