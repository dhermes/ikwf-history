...
_SENIOR_COMPETITORS: dict[int, list[str | None]] = {
    ...
    130: [
        ...
        # ? Alternate ? "AMADOR ESTRADA :: ROUND LAKE",
        # ? Alternate ? "ANTHONY BINION :: WARHAWKS",
        # ? Alternate ? "BEN BRUNNER :: BLACKHAWK II",
        # ? Alternate ? "BRAD VERMILLION :: CRYSTAL LAKE",
        # ? Alternate ? "BRADY RUEL :: ST. BARNABAS / CHRIST THE KING",
        # ? Alternate ? "BRETT HOERR :: MORTON",
        # ? Alternate ? "BRIAN CLODFELTER :: TIGERTOWN",
        # ? Alternate ? "BRIAN EVERETT :: GIBSON CITY",
        # ? Alternate ? "DAVID STOLTZ :: MEAD",
        # ? Alternate ? "DERRICK LOLLIS :: HARVEY",
        # ? Alternate ? "ETHAN CRANE :: GC COOLIDGE",
        # ? Alternate ? "JAMIE FENDER :: FISHER",
        # ? Alternate ? "JASON ETZKORN :: LEMONT",
        # ? Alternate ? "JOHN THORPE :: FROST",
        # ? Alternate ? "JOSHUA TURYNA :: ST. BARNABAS / CHRIST THE KING",
        # ? Alternate ? "MARK MANKOWSKI :: HICKORY HILLS",
        # ? Alternate ? "MICHAEL MARTINEZ :: WAUKEGAN",
        # ? Alternate ? "MIKE MURPHY :: LITTLE CELTIC",
        # ? Alternate ? "RANDY ATERS :: LIL REAPER",
        # ? Alternate ? "ROY PIERCE :: SPARTANS",
        # ? Alternate ? "SAM MOHR :: PLAINFIELD",
        # ? Alternate ? "SCOTT KENNY :: ORLAND PARK",
        # ? Alternate ? "SEAN PIPPIN :: GENESEO",
        # ? Alternate ? "TERENCE KENNEBREW :: PIRATES",
        # ? Alternate ? "TIM TYNSKI :: CRESTWOOD",
    ],
    138: [
        "AARON SHADAB :: ELGIN",
